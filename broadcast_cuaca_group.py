...
def fetch_weather_group(m_list, part_title):
    alerts = []
    reports = []
    ...
    out = f"LAPORAN LIVE CUACA GUNUNG PULAU JAWA & BALI ({part_title}) 🏔️\n\n" + "\n".join(reports)
    if alerts:
        out += "\n\nPERINGATAN CUACA EKSTREM / HUJAN:\n" + "\n".join(alerts)
    return out

if __name__ == "__main__":
    p1 = fetch_weather_group(MOUNTAINS_PART1, "BAGIAN 1 - JATENG, DIY, & JABAR")
    p2 = fetch_weather_group(MOUNTAINS_PART2, "BAGIAN 2 - JABAR, JATIM, & BALI")
