...
Silakan menyapa sesama pendaki, cari teman muncak, atau gunakan fitur bot kami:
• `cuaca <nama_gunung>` ➔ Prakiraan cuaca live
• `rekomendasi <kriteria>` ➔ Rekomendasi rute AI
• `info` ➔ Website & link resmi RuteStrip
